...
class Duck:
    def __init__(self):
        ...
        self.image = pygame.image.load(
            resource_path(
                random.choices(
                    population=['duck.png', 'stork.png', 'twitter.png'],
...
class Gun:
    def __init__(self):
        self.x = game.w // 2
        self.y = game.h // 2
        self.image = pygame.image.load(resource_path('shooter.png'))
        self.area = game.display.blit(self.image, [self.x, self.y])
        self.score = 0
...
class Game:
    def __init__(self):
        self.w = 852
        self.h = 480
        self.background = pygame.image.load(resource_path('background.jpg'))
        self.display = pygame.display.set_mode((self.w, self.h))
        pygame.display.set_caption('Duck Hunt')
        pygame.display.set_icon(pygame.image.load(resource_path('shooter.png')))
